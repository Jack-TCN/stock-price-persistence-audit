...
FIG_DIR = PROJECT_ROOT / "figures" / "cross_market_modern_audit"
...
def main() -> None:
    ...
    fig.tight_layout()
    fig.savefig(FIG_DIR / "rmse_ratio_distribution.pdf", bbox_inches="tight")
    fig.savefig(FIG_DIR / "rmse_ratio_distribution.png", dpi=220, bbox_inches="tight")
    print(FIG_DIR / "rmse_ratio_distribution.pdf")
